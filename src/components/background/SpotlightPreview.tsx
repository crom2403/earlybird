...
export function SpotlightPreview() {
  return (
    <BackgroundBeamsWithCollision className="absolute inset-0 z-[-10] md:h-[calc(100vh-64px)] h-[calc(100vh-64px)]">
      <div className="absolute inset-0 z-[-10] md:h-[calc(100vh-64px)] w-full flex md:items-center md:justify-center dark:bg-black/[0.96] antialiased dark:bg-grid-white/[0.02] bg-grid-black/[0.04] overflow-hidden">
